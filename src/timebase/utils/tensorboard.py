...
def set_xticks(
    ...
    axis.set_xticklabels(ticks, fontsize=tick_fontsize, **kwargs)
    if label:
        axis.set_xlabel(label, fontsize=label_fontsize, labelpad=label_pad)
...
def set_yticks(
    ...
    if rotation is not None:
        kwargs["rotation"] = rotation
        kwargs["verticalalignment"] = "center"
    axis.set_yticklabels(ticks, fontsize=tick_fontsize, **kwargs)
    if label:
...
class Summary(object):
    ...
    def __init__(self, args):
        ...
        # create SummaryWriter for train, validation, and test set, target
        # train and target validation set
